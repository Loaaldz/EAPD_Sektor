	...
	<head>
  	...
  	<body>
		  ...
		  <div class="form-label-group">
		    <input type="text" name="nrk" id="nrk" class="form-control login-form" placeholder="NRK" required autofocus>
		    <label for="nrk">NRK</label>
		  </div>

		  <div class="form-label-group">
		    <input type="password" name="password" id="inputPassword" class="form-control login-form" placeholder="Password" required>
